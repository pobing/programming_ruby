...
# => [1, 2, 3]
# 联合
# 1.9.2p320 :100 > [1,1,1,2,3] | [2,3,41,1]
#  => [1, 2, 3, 41]
...
# 1.9.2p320 :112 > a=%w(a b c d)
#  => ["a", "b", "c", "d"]
# 1.9.2p320 :113 > a.fill("x")
#  => ["x", "x", "x", "x"]
# 1.9.2p320 :114 > a.fill("y",2,2)
#  => ["x", "x", "y", "y"]
# 1.9.2p320 :115 > a.fill("z",0,1)
#  => ["z", "x", "y", "y"]
# a.fill(-3) {|i| i+100}
#  => [0, 101, 102, 103]
# 1.9.2p320 :125 >
